...
- **Type:** Refactor
- **Traceability:** relocates the existing FR-DAT-1/FR-DAT-2/FR-DAT-3 surface (export, import, delete-all — [v1.4 TICKET-DAT-01](../../data-management/tickets/TICKET-DAT-01-full-data-export-import.md), [TICKET-DAT-03](../../data-management/tickets/TICKET-DAT-03-delete-all-data.md)); no new capability, no FR change
...
- Independent of the other Settings-track tickets (SET-02/03/04/05, PRIV-01) and of [TICKET-PUB-06](../../help/tickets/TICKET-PUB-06-github-repo-link.md) — no build-order dependency either way, though it pairs naturally with PUB-06's optional Settings "About" section if both land around the same time (both add a small secondary section below the theme picker).
