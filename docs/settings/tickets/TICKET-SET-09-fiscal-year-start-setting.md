...
- **Type:** Feature
- **Traceability:** new capability from [v1.8's requirements sketch](../../releases/v1.8_extended_date_range_picker/requirements.md) (the
  ...
  [TICKET-SET-04](./TICKET-SET-04-locale-setting.md) and
  [TICKET-INC-12](../../income/tickets/TICKET-INC-12-career-start-date.md), and the
  one-component-per-section structure of
  [TICKET-SET-07](./TICKET-SET-07-settings-section-components.md).
...
[STAT-37](../../dashboard/tickets/TICKET-STAT-37-quick-range-catalogue.md)'s two fiscal quick ranges have a boundary to
resolve against.
...
- [x] Nothing else in the app changes behaviour as a result of this ticket — the existing quarter and
      ...
      [STAT-37](../../dashboard/tickets/TICKET-STAT-37-quick-range-catalogue.md) ships. (No file under
...
- **Why the setting ships before anything reads it.** It is the only piece of
  [STAT-37](../../dashboard/tickets/TICKET-STAT-37-quick-range-catalogue.md) that touches persistence and Settings, and
