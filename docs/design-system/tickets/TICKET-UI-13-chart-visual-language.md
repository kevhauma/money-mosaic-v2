...
- **Released in:** [v1.5 Redesign](../../releases/v1.5_redesign/overview.md)
- **Type:** Feature
...
[design-language.md](../../releases/v1.5_redesign/design-language.md) §2 has the validated 6-slot categorical palette (light + dark, CVD-checked) and §6 has the animation duration/easing values to use.
...
- [TICKET-STAT-20](../../dashboard/tickets/TICKET-STAT-20-trend-chart-accessible-numbers.md) already mirrors the trend chart's key numbers into an `sr-only` DOM table for screen readers — any palette change here must not regress that accessible-numbers coverage.
...
- [TICKET-STAT-20](../../dashboard/tickets/TICKET-STAT-20-trend-chart-accessible-numbers.md)'s `sr-only` table continues to reflect the same series data unchanged by this ticket's palette/motion work.
