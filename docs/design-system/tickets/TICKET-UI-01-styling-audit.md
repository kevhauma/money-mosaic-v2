...
- Results committed as `docs/releases/v1.5_redesign/audit-results.md`: a table of pattern → matching files/line counts → the ticket (UI-02..UI-10) it feeds, so each extraction ticket's acceptance criteria can reference a real file list rather than "however many prepare.md happened to notice."
...
- [x] `docs/releases/v1.5_redesign/audit-results.md` committed, grouping every match by the primitive ticket it belongs to
