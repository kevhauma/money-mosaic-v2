...
- **Area:** Design System
- **Released in:** [v1.9 Deformable UI redesign](../../releases/v1.9_deformable_ui_redesign/overview.md)
- **Type:** Refinement
...
([design-language.md](../../releases/v1.9_deformable_ui_redesign/design-language.md)):
...
3. **Wider `mm-blob` use.** Per [v1.9_deformable_ui_redesign/overview.md](../../releases/v1.9_deformable_ui_redesign/overview.md)'s
