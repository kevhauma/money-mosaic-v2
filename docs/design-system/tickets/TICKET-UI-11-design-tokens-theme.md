...
The actual token values (colors, type scale, elevation, the aurora-wash gradient recipe) are specified in [design-language.md](../../releases/v1.5_redesign/design-language.md) §1, §3, §4 — implement from there rather than re-deriving values from prepare.md's feelings/terms directly.
