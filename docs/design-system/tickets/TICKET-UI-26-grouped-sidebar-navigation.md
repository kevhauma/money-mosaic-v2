...
- **Traceability:** extends the app-shell navigation of
  [ui-layout-spec.md](../../reference/ui-layout-spec.md) §Navigation; continues the shell
  work of [TICKET-UI-14](./TICKET-UI-14-app-shell-visual-pass.md) and the
  nav trim of [TICKET-SET-06](../../settings/tickets/TICKET-SET-06-move-data-nav-into-settings.md). No new
...
- The eight feature links render as two always-expanded groups inside the existing sidebar `menu`:
  - **Insights** — Dashboard, Income, Explore (and `/future` once
    [TICKET-FUT-03](../../future/tickets/TICKET-FUT-03-future-page-scaffold.md)
    lands — see Notes).
...
- **Interaction with [TICKET-FUT-03](../../future/tickets/TICKET-FUT-03-future-page-scaffold.md).**
...
- This ticket deliberately changes nothing about the routes themselves. The classification it
  ...
  [TICKET-PRIV-02](../../settings/tickets/TICKET-PRIV-02-hide-amounts-on-every-insight-page.md), which puts the
