...
- TICKET-SET-01 has introduced the `appSettings` table/repository/store/`/settings` page this ticket extends for the persisted toggle state.
...
- Depends on TICKET-SET-01 for the `appSettings` table/store/page shell; independent of SET-02/03/04.
