...
- **Released in:** [v1.4 Data management](../../releases/v1.4_data_management/overview.md)
- **Type:** Feature
...
- This was already spec'd as FR-DAT-1/FR-DAT-2 in [finance-app-spec.md:109-110](../../reference/finance-app-spec.md) and restated as user stories in this version's [data_management.md](../../releases/v1.4_data_management/data_management.md), but never broken into a ticket or built — the feature is a documented gap, not a new idea.
...
- This ticket is the natural prerequisite for [TICKET-PUB-04](../../help/tickets/TICKET-PUB-04-local-data-migration-messaging.md) (v2's "your data never leaves the browser, here's how to move it" messaging) — that ticket links to this one's Export/Import UI rather than re-describing the mechanism.
