...
- **Traceability:** extends **FR-REC-1/2/3** with **FR-CAT-9**'s window
  ([TICKET-CAT-10](../../categories/tickets/TICKET-CAT-10-category-applicability-range.md)). This is the ticket the
...
- After [TICKET-REC-01](./TICKET-REC-01-recurring-payment-detection.md)..[04](./TICKET-REC-04-recurring-change-flags.md),
  ...
  expected".
- After [TICKET-CAT-10](../../categories/tickets/TICKET-CAT-10-category-applicability-range.md) the category carries
...
- The category window is per-*category*, so it fits costs that end with a life chapter (rent,
  ...
  overview.
- Needs [TICKET-CAT-10](../../categories/tickets/TICKET-CAT-10-category-applicability-range.md) and
