...
- [x] Virtualized table performance ([TICKET-TXN-02](./TICKET-TXN-02-virtualized-table.md)) is not regressed — the inline select renders cheaply per row (reuse `mm-select`, not a new heavy component).
