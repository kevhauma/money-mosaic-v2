...
- **Type:** Refactor
- **Traceability:** CR4-1 §5 Options A+B+C ([solution doc](../../releases/v2_code_review/solutions/CR4-01-template-complexity.md)) — C included by explicit user decision, overriding the doc's over-extraction caution
