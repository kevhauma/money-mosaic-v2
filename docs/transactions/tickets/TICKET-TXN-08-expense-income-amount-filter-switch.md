...
- This is a QoL/interaction ticket, not part of the v1.5 styling rework — filed under `docs/releases/v1.5_redesign`'s "QoL addendum" section at the user's request, same as [TICKET-IMP-07](../../import/tickets/TICKET-IMP-07-guided-mapper-feedback.md) and [TICKET-CAT-07](../../categories/tickets/TICKET-CAT-07-make-rule-from-filter.md). Independent of any `TICKET-UI-*` ticket.
