...
- [ ] [TICKET-STAT-11](./tickets/TICKET-STAT-11-signed-category-breakdown-netting.md) — Category-kind-driven netting for income/expense totals and breakdown (bug fix, fixes FR-STAT-2/FR-STAT-3 — refunds/paybacks on an expense category inflate its total and count as income overall instead of netting down) — independent, small, can ship any time
- [ ] [TICKET-CAT-04](./tickets/TICKET-CAT-04-rules-search-filter.md) — Search and filter on the Rules screen (extends FR-CAT-2) — independent of the stats tickets above; small UI addition, can ship any time
