...
- **Traceability:** revises **FR-STAT-7**'s notion of a stored range. Builds on
  ...
  [TICKET-UI-23](../../design-system/tickets/TICKET-UI-23-per-page-date-range.md) made
  per-page and [TICKET-SOLID-07](../../engineering/tickets/TICKET-SOLID-07-range-state-store-to-core-state.md)
  moved to `core/state`.
