...
- **Type:** Feature
- **Traceability:** extends FR-STAT-7; precursor to [../v1.8_extended_date_range_picker/requirements.md](../../releases/v1.8_extended_date_range_picker/requirements.md)
