...
- **Type:** Feature
- **Traceability:** extends **FR-STAT-15** ([TICKET-STAT-29](./TICKET-STAT-29-spending-heatmap-panel.md)); follows the per-chart control precedent of [TICKET-STAT-15](./TICKET-STAT-15-independent-trend-chart-bucket-controls.md) and [TICKET-STAT-27](./TICKET-STAT-27-session-persistent-chart-options.md).
