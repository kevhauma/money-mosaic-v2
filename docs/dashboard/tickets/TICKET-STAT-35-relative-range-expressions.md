...
- **Traceability:** extends **FR-STAT-7**; the foundation every other ticket in
  [v1.8](../../releases/v1.8_extended_date_range_picker/overview.md) resolves a range through. Successor to
  [TICKET-STAT-16](./TICKET-STAT-16-date-range-prev-next-navigation.md),
...
- Independent of [SET-09](../../settings/tickets/TICKET-SET-09-fiscal-year-start-setting.md) — fiscal snapping is not part
