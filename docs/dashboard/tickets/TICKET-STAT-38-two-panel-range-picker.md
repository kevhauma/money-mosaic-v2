...
- **Traceability:** revises **FR-STAT-7**'s picker UI; retires the switcher built by
  [TICKET-STAT-10](./TICKET-STAT-10-unified-date-range-picker.md) and
  extended by [TICKET-STAT-16](./TICKET-STAT-16-date-range-prev-next-navigation.md),
  on the three pages [TICKET-UI-23](../../design-system/tickets/TICKET-UI-23-per-page-date-range.md)
