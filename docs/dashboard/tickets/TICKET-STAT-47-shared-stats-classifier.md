# TICKET-STAT-47 — Extract the shared per-transaction stats classifier

- **Area:** Statistics (core/stats)
- **Released in:** [v1.3 Code review (CR3)](../../releases/v1.3_code_review/overview.md)
- **Type:** Refactor
- **Traceability:** CR3-2.1; consolidates the semantics of TICKET-STAT-46, TICKET-STAT-11, TICKET-TXN-03, TICKET-TXN-04, TICKET-CAT-02, TICKET-TRF-02
