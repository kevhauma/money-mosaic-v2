...
- **Type:** Feature
- **Traceability:** extends **FR-STAT-15** ([TICKET-STAT-29](./TICKET-STAT-29-spending-heatmap-panel.md)); mirrors the exclusion control the category period comparison panel already offers for FR-STAT-8 ([TICKET-STAT-04](./TICKET-STAT-04-category-period-comparison.md)).
