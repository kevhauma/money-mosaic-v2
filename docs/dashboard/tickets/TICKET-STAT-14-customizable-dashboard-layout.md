...
- **Released in:** [v1.3 Dashboard insights](../../releases/v1.3_dashboard_insights/overview.md)
- **Type:** Feature
- **Traceability:** extends [dashboard-layout.md](../../releases/v1.3_dashboard_insights/dashboard-layout.md); no existing FR-STAT covers layout personalization
