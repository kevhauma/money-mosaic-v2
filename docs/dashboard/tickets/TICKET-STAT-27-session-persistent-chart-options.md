...
- [x] Hiding a series then changing the bucket size leaves it hidden; component spec on the accounts
      ...
      change". **Superseded the same day by [TICKET-ACC-10](../../accounts/tickets/TICKET-ACC-10-day-only-balance-buckets.md)**,
...
- Ties into [TICKET-UI-23](../../design-system/tickets/TICKET-UI-23-per-page-date-range.md) only by symptom. That ticket stops the
