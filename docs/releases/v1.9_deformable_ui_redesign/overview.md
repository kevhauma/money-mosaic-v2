...
- [x] [TICKET-UI-16](../../design-system/tickets/TICKET-UI-16-theme-icon-separator.md) — Per-theme brand icon &
...
- [x] [TICKET-UI-17](../../design-system/tickets/TICKET-UI-17-single-theme-selector.md) — Collapse to a single theme
...
- [x] [TICKET-UI-18](../../design-system/tickets/TICKET-UI-18-full-tile-theme-preview.md) — Full-tile live theme
      preview (adds FR-UI-18) — needs UI-17's tile template
- [x] [TICKET-UI-19](../../design-system/tickets/TICKET-UI-19-no-hover-zoom-rule.md) — Remove intense hover-zoom, add
      a no-hover-scale design rule — independent, audit-and-prevent
- [x] [TICKET-UI-20](../../design-system/tickets/TICKET-UI-20-neumorphism-light-variant.md) — Neumorphism: use its
      light-mode clay variant instead of the dark port — independent
- [x] [TICKET-UI-21](../../design-system/tickets/TICKET-UI-21-default-theme-polish.md) — Default theme polish: safer
