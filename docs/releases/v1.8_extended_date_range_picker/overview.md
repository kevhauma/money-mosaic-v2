...
The lineage is [TICKET-STAT-01](../../dashboard/tickets/TICKET-STAT-01-custom-range-enable.md) →
[STAT-03](../../dashboard/tickets/TICKET-STAT-03-expanded-range-presets-default-grouping.md) →
[STAT-10](../../dashboard/tickets/TICKET-STAT-10-unified-date-range-picker.md) →
[STAT-16](../../dashboard/tickets/TICKET-STAT-16-date-range-prev-next-navigation.md), all
...
3. **The full quick-range catalogue ships, fiscal included** — which means a fiscal-year-start
   setting has to exist first, hence [SET-09](../../settings/tickets/TICKET-SET-09-fiscal-year-start-setting.md).
...
- [x] [TICKET-STAT-35](../../dashboard/tickets/TICKET-STAT-35-relative-range-expressions.md) — Relative range
      ...
      **first**, and pure utility code with no UI: every other ticket in this version resolves a
      range through it
- [x] [TICKET-STAT-36](../../dashboard/tickets/TICKET-STAT-36-expression-backed-range-state.md) — `RangeStore`
...
- [x] [TICKET-SET-09](../../settings/tickets/TICKET-SET-09-fiscal-year-start-setting.md) — Fiscal year start
...
- [x] [TICKET-STAT-37](../../dashboard/tickets/TICKET-STAT-37-quick-range-catalogue.md) — The quick-range
...
- [x] [TICKET-STAT-38](../../dashboard/tickets/TICKET-STAT-38-two-panel-range-picker.md) — The two-panel picker
...
- [x] [TICKET-STAT-39](../../dashboard/tickets/TICKET-STAT-39-absolute-panel-apply-staging.md) — The absolute
      ...
      is typed
- [x] [TICKET-STAT-40](../../dashboard/tickets/TICKET-STAT-40-recently-used-ranges.md) — Recently used ranges,
...
- [x] [TICKET-STAT-41](../../dashboard/tickets/TICKET-STAT-41-standalone-picker-year-navigation.md) — Quick year
...
- **"History `[🕘]`" vs "Recent values `[📋]`" vs the "Recently used" list** — three surfaces for one
  concept. Collapsed to a single list, no separate buttons ([STAT-40](../../dashboard/tickets/TICKET-STAT-40-recently-used-ranges.md)).
- **Two search boxes** (header `[ Search ]` and the right panel's `🔍 Search quick ranges`) — one
  control, in the quick-range panel ([STAT-38](../../dashboard/tickets/TICKET-STAT-38-two-panel-range-picker.md)).
- **"Closes on Esc/outside click *unless* there are unapplied edits"** — the sketch never says what
  ...
  ([STAT-39](../../dashboard/tickets/TICKET-STAT-39-absolute-panel-apply-staging.md)).
...
- **Where prev/next lives** — the sketch's interaction model preserves
  [STAT-16](../../dashboard/tickets/TICKET-STAT-16-date-range-prev-next-navigation.md)'s
  stepping but its layout has nowhere to put the chevrons. Resolved: they stay outside the popover,
  flanking the trigger ([STAT-38](../../dashboard/tickets/TICKET-STAT-38-two-panel-range-picker.md)).
- **"Dark-themed popover, ~850×500px"** — the app has nine themes and a standing no-fixed-dark rule.
  ...
  ([STAT-38](../../dashboard/tickets/TICKET-STAT-38-two-panel-range-picker.md)).
- **Duplicate quick ranges** — the sketch's list overlaps today's by four entries under different
  ...
  full rename table in [STAT-37](../../dashboard/tickets/TICKET-STAT-37-quick-range-catalogue.md).
...
- **The Transactions filter adopting the picker** — see scope decision 4 above. Worth revisiting only
  ...
  [TICKET-STAT-41](../../dashboard/tickets/TICKET-STAT-41-standalone-picker-year-navigation.md), which adds a
...
- **A grouping-granularity control in the popover.** Granularity has been per-chart since
  [TICKET-STAT-15](../../dashboard/tickets/TICKET-STAT-15-independent-trend-chart-bucket-controls.md) and
