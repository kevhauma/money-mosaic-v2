...
Finding: [CR4-11](../code-review.md#cr4-11--the-project-map-skill--the-designated-read-this-instead-of-exploring-doc--is-materially-stale). The skill predates ~half the app: missing 4 of 11 features, reversed hydration model, misplaced files, stale `/data` and `docs/releases/v2` claims, half the shared/ui inventory absent.
...
- Docs section → `docs/releases/v2` is the shipped Public Ready milestone; add v1.5–v1.9 and the review folders, or defer wholly to `docs/README.md` instead of re-listing.
