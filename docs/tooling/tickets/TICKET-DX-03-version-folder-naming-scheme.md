...
- **Released in:** [v1.3 Code review (CR3)](../../releases/v1.3_code_review/overview.md)
...
- [x] If renamed: zero broken relative links (`grep -rn "coding-review-2\|docs/releases/code-review" docs .claude CLAUDE.md` reflects the new reality); if grandfathered: the note names the grandfathered folders explicitly so they don't read as counter-examples.
