...
- **Type:** Refactor
- **Traceability:** CR4-2 sequencing note ([solution doc](../../releases/v2_code_review/solutions/CR4-02-import-wizard-commit-flow.md) — "the regression suite this flow has never had at the flow level")
