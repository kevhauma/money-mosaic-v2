...
- [x] The config file carries a comment linking to review §5 (`docs/releases/v1.3_code_review/code-review-fallow.md`) as the evidence trail (`.fallowrc.json` accepts JSONC comments).
