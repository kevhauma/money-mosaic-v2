...
- **Released in:** [Code review 1 (CR1)](../../releases/code-review/overview.md)
- **Type:** Refactor
...
- This ticket is a prerequisite for the CR-8 dialog-a11y item (`aria-labelledby` + focus restore) in [overview.md](../../releases/code-review/overview.md) §8.
