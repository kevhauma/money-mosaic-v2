...
- **Type:** Refactor
- **Traceability:** CR4-2 Option A ([solution doc](../../releases/v2_code_review/solutions/CR4-02-import-wizard-commit-flow.md)); supersedes CR4-1 §1 Options A/B ([template doc](../../releases/v2_code_review/solutions/CR4-01-template-complexity.md))
