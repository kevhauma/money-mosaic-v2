...
- Directly downstream of [TICKET-TRF-04](../../transfers/tickets/TICKET-TRF-04-normalize-iban-matching.md) — found while verifying that ticket's fix against a real user dataset; TRF-04's normalization is necessary but not sufficient when the field is missing rather than malformed.
