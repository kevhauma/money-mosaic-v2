...
- **Type:** Refactor
- **Traceability:** revises TICKET-ML-10/ML-12 presentation (FR-CAT-8 auto-categoriser), needs [TICKET-UI-22](../../design-system/tickets/TICKET-UI-22-page-header-contract.md)
...
- **The subtitle is removed**, per [TICKET-UI-22](../../design-system/tickets/TICKET-UI-22-page-header-contract.md).
