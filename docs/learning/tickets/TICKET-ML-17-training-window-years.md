...
- `docs/releases/v1.8_extended_date_range_picker/requirements.md` describes a full Grafana-style date-range picker
...
- Deliberately does **not** depend on `docs/releases/v1.8_extended_date_range_picker` — that's an unticketed, unbuilt
