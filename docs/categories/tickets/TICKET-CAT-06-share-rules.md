...
- **Type:** Feature
- **Traceability:** extends FR-CAT-2; same export/import shape as FR-DAT-1/FR-DAT-2 ([TICKET-DAT-01](../../data-management/tickets/TICKET-DAT-01-full-data-export-import.md)), scoped to the `rules` table only
...
- This is the "partial export/import" case v1.4's [overview.md](../../releases/v1.4_data_management/overview.md) explicitly deferred out of TICKET-DAT-01's scope ("Considered, not ticketed yet") — this ticket is that deferred feature, scoped to `rules`.
