...
- **Type:** Feature
- **Traceability:** extends TICKET-PUB-02 (how-to guides) / TICKET-PUB-03 (FAQ), needs [TICKET-UI-24](../../design-system/tickets/TICKET-UI-24-header-start-and-end-action-sections.md)
...
- **Copy matches the nav item, not the route.** The sidebar and the index page both call this section
  ...
  sees.
- If [TICKET-UI-24](../../design-system/tickets/TICKET-UI-24-header-start-and-end-action-sections.md) has not landed, this is
