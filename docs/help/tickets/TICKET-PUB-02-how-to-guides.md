...
- `docs/reference/finance-app-spec.md` and the per-version `overview.md`/ticket files are developer-facing specs, not user-facing help copy — this ticket writes new, separate user-facing content, it does not repurpose those docs directly.
