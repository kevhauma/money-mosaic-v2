...
- [ ] [TICKET-STAT-34](./tickets/TICKET-STAT-34-heatmap-per-category-colour-scales.md) — Each heatmap row shaded in its own category colour, anchored on that row's average and readable in light and dark (revises FR-STAT-15's colour encoding) — **needs STAT-29**; independent of STAT-31/32, from feedback on the shipped panel. Listed before STAT-33 because it replaces STAT-29's single `visualMap` with the per-row colour resolution STAT-33 also needs
