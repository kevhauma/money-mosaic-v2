...
- [x] [TICKET-STAT-33](./tickets/TICKET-STAT-33-heatmap-all-row.md) — An "All" row at the top of the spending heatmap, on its own scale and separated from the categories (extends FR-STAT-15) — **needs STAT-29**; **cheaper after STAT-34**, though it can be built alone at the cost of a two-scale arrangement STAT-34 then removes
