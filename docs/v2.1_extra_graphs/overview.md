...
- [ ] [TICKET-REC-06](./tickets/TICKET-REC-06-stopped-series-collapsed.md) — Collapse the stopped series group, closed by default (extends FR-REC-2) — **needs REC-04** (shipped); independent of every open ticket, can ship any time; from feedback on the shipped panel
