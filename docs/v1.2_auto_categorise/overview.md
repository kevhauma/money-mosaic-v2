...
- [x] [TICKET-ML-16](./tickets/TICKET-ML-16-confidence-gradient-badge.md) — Colour the suggestions table's suggestion badge on a red-to-green gradient by confidence (extends FR-ML-13, adds FR-ML-16) — needs ML-13; purely presentational, independent of everything else, can ship any time
