...
- **Area:** Income
- **Type:** Refactor
- **Traceability:** revises FR-INC-1 presentation / TICKET-INC-18, needs [TICKET-UI-22](./TICKET-UI-22-page-header-contract.md)
...
- **The subtitle is the longest in the app**: `"How your income moves over time — by source, year over
  year, and against the noise."` [TICKET-UI-22](./TICKET-UI-22-page-header-contract.md) removes it.
...
- **No date range in this header.** `/income` deliberately ignores the shared range and scopes itself to
  ...
  [TICKET-UI-23](./TICKET-UI-23-per-page-date-range.md) explicitly does not give this page one.
