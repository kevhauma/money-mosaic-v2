...
- **Area:** Shared UI
- **Type:** Refactor
- **Traceability:** revises `docs/v1.0_foundation/ui-layout-spec.md` (page header), extends TICKET-UI-14 (app-shell visual pass)
...
own header contents ship as their own ticket ([TICKET-STAT-25](./TICKET-STAT-25-dashboard-page-header.md),
[TICKET-ACC-08](./TICKET-ACC-08-accounts-page-header.md),
[TICKET-INC-21](./TICKET-INC-21-income-page-header.md),
[TICKET-CAT-09](./TICKET-CAT-09-categories-rules-page-header.md),
[TICKET-ML-18](./TICKET-ML-18-learning-page-header.md)) — and this one covers the primitive plus every
