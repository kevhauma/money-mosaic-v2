...
- [ ] [TICKET-CAT-09](./tickets/TICKET-CAT-09-categories-rules-page-header.md) — Categories/Rules header: the switch, the create button, and each tab's own control (extends FR-CAT-1/FR-CAT-4) — needs UI-22 only
- [ ] [TICKET-ML-18](./tickets/TICKET-ML-18-learning-page-header.md) — Learning header: the model's status, in the header (revises TICKET-ML-10/ML-12 presentation) — needs UI-22 only; smallest of the five
