...
- [ ] [TICKET-IMP-10](./tickets/TICKET-IMP-10-import-map-step-extraction.md) — Extract import-map-step's shared vocabulary and pure derivations (CR4-4 A+B, CR4-7.2) — mechanical, do first; unblocks IMP-11 and half of CR4-7
