...
subgraph 79["tabs"]
7A["tabs.component.ts"]
end
subgraph 7B["typography"]
7C["typography.component.ts"]
end
end
subgraph 7D["utils"]
7E["confidence-color.ts"]
7F["confirm-state.ts"]
7G["currency-format.ts"]
7H["daisy-classes.ts"]
7I["date-buckets.ts"]
7J["debounced-text.ts"]
7K["download-json.ts"]
7L["fingerprint.ts"]
7M["iban.ts"]
7N["index.ts"]
...
7P["percentage.ts"]
7Q["search-params.ts"]
7R["selection-model.ts"]
7S["signed-amount.pipe.ts"]
7T["sortable.ts"]
7U["structural-filters.ts"]
subgraph 7V["validators"]
7W["iban.validator.ts"]
7X["percentage.validator.ts"]
end
7Y["with-archivable.ts"]
7Z["with-persisted-crud.ts"]
end
end
end
end
