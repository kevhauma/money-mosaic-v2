...
- **Type:** Refactor
- **Traceability:** extends FR-ACC-1 (account management), needs [TICKET-UI-22](../../design-system/tickets/TICKET-UI-22-page-header-contract.md) + [TICKET-UI-23](../../design-system/tickets/TICKET-UI-23-per-page-date-range.md)
...
- It also carries the subtitle `"Every account you track, in one place."`, which
  [TICKET-UI-22](../../design-system/tickets/TICKET-UI-22-page-header-contract.md) removes app-wide.
...
- **The header holds three things, left to right:** the "Show archived" toggle, the Accounts page's own
  `mm-range-grouping-switcher` (from [TICKET-UI-23](../../design-system/tickets/TICKET-UI-23-per-page-date-range.md)), and the
...
[TICKET-UI-23](../../design-system/tickets/TICKET-UI-23-per-page-date-range.md) — that ticket's own browser criterion
