...
- Related: [TICKET-TRF-01](../../transfers/tickets/TICKET-TRF-01-clear-category-on-link.md) (transfer-link cleanup semantics) and FR-IMP-7 batch undo (the narrower existing recovery path this complements).
