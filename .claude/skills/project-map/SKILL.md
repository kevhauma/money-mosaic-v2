...
| `/accounts` | `feature-accounts/` | *(consumes `AccountsStore`)* | accounts-overview, accounts-detail, account-form, account-card, account-balance-block, account-balance-chart, account-balance-history-chart; `account-card-vm.ts`, `account-icons.ts` |
